var ResetpwdHandler = function () {
}

ResetpwdHandler.prototype.listenSendCaptchaEvent = function () {
...
ResetpwdHandler.prototype.listenGraphCaptchaEvent = function () {
...
ResetpwdHandler.prototype.listenSubmitEvent = function (){
...
ResetpwdHandler.prototype.run = function () {
...
$(function () {
    var handler = new ResetpwdHandler();
    handler.run();
})
